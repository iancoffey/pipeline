...
var eventbindingsResource = schema.GroupVersionResource{Group: "tekton.dev", Version: "v1alpha1", Resource: "eventbindings"}

var eventbindingsKind = schema.GroupVersionKind{Group: "tekton.dev", Version: "v1alpha1", Kind: "EventBinding"}
